...
export interface DeleteModelsWithoutSourcesResponse {
  deletedCount: number;
}

export interface DeleteModelsWithoutSourcesResponseDoc {
  data: DeleteModelsWithoutSourcesResponse;
  errorMsg: string;
}
...
export namespace Admin {
   ...
   * @tags llm
   * @name LlmModelsDeleteWithoutSourcesCreate
   * @summary 管理员删除所有无上游模型
   * @request POST:/admin/llm/models/delete-without-sources
   * @secure
   */
  export namespace LlmModelsDeleteWithoutSourcesCreate {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = DeleteModelsWithoutSourcesResponseDoc;
  }
